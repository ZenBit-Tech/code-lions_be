...
export const Errors = {
  ...
  FAILED_TO_REJECT_ORDER: 'Failed to reject the order',
  FAILED_TO_SEND_ORDER: 'Failed to send the order',
  FAILED_TO_RECEIVE_ORDER: 'Failed to receive the order',
  FAILED_TO_SEND_BACK: 'Failed to send the order back',
  FAILED_TO_RETURN_ORDER: 'Failed to return the order',
  FAILED_TO_PAY_AND_SEND: 'Failed to pay and send the order back',
  ...
  UNABLE_TO_RETRIEVE_USER_CHATS: 'Unable to retrieve user chats',
  UNABLE_TO_RETRIEVE_CHAT: 'Unable to retrieve chat',
  CHAT_ROOM_NOT_FOUND: 'Chat room not found',
  USER_IS_NOT_IN_THIS_CHAT_ROOM: 'User is not part of chat room',
  FIRST_USER_NOT_FOUND: 'First user not found',
  SECOND_USER_NOT_FOUND: 'Second user not found',
  UNABLE_TO_CREATE_CHAT: 'Unable to create chat',
  UNABLE_TO_CREATE_CHAT_WITH_ADMIN: 'Unable to create chat with admin',
  UNABLE_TO_SEND_MESSAGE: 'Unable to send message',
  UNABLE_TO_UPLOAD_FILE: 'Unable to upload file',
  MESSAGE_HAS_NO_SENDER: 'Message has no sender',
  UNABLE_TO_MARK_MESSAGE_AS_READ: 'Unable to mark message as read',
  UNABLE_TO_COUNT_UNREAD_MESSAGES: 'Unable to count unread messages',
